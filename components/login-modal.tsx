...
import { X, Eye, EyeOff, BookOpen, Mail, Lock, ArrowRight, Loader2, CheckCircle, XCircle, Sparkles, UserPlus } from "lucide-react"
          ...
          {alert && (
            <Alert className={`mb-6 ${alert.type === 'success' ? 'border-green-500 bg-green-50' : 'border-red-500 bg-red-50'}`}>
              <div className="flex items-center">
                ...
                <AlertDescription className={`${alert.type === 'success' ? 'text-green-800' : 'text-red-800'} text-sm leading-tight break-words`}>
                  {alert.message}
                </AlertDescription>
              </div>
            </Alert>
